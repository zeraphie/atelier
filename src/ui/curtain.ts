 ...
 * on the compositor while they run. The curtain opens at the later of
 * the draw's end and the first frame, and the two halves part with
 * their share of the letters. A load that fails says so under the
 * mark. The lengths are written down twice: here, and in the rules of
 * index.html.
