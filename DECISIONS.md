...
<!-- Each entry in your words: the decision, why, what else was weighed, what it cost. Short. -->
...
<!-- What was tuned after it worked, and why: trackpad feel, pins as affordances, retina text, spacing and type. -->

## Cut, deferred, and next

<!-- Only list as next what you could do live. -->

## How I worked

<!-- The .ai/ folder is the contract the agents worked under; the prose here is yours. -->
